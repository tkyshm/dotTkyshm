...
bar=$(echo $pos | dzen2-gdbar -w 190 -h 1.5 -fg "#FF3D00" -bg "#821D00")
echo -n "$bar"
return
}

font="M+ 1c-7"
icon="/home/tkyshm/.icons/xbm8x8"
...
$(position)" 
done | dzen2 -p -y 25 -x 1083 -l 5 -u -w 190 -ta l -fn "$font" -e 'onstart=uncollapse;key_Escape=ungrabkeys,exit'
